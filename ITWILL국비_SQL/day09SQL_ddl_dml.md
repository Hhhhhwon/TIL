# 목차
- [목차](#목차)
  - [DDL(Data Definition Language): create, alter, drop, truncate](#ddldata-definition-language-create-alter-drop-truncate)
  - [DML(Data Manipulation Language): insert, update, delete](#dmldata-manipulation-language-insert-update-delete)
